                ...
                <?php
                    ...
                    while ($row = mysqli_fetch_row($result)) {
                        $sql_info = "SELECT DISTINCT
                                    ...
                                    WHERE
                                        matinfo.matinfo_matname = $row[3] 
                                        AND (projmateng.projmateng_mateng = $accounts_id OR projmateng.projmateng_mateng = 1)";
                        $result_info = mysqli_query($conn, $sql_info);
                        while ($row_info = mysqli_fetch_row($result_info)) {
                        if($row_info[0] <= $row_info[1]) {
                ?>
                <tr>
                    <td><?php echo $row[0] ;?></td>
                    <td><?php echo $row[1] ;?></td>
                    <td><?php echo $row_info[0] ;?></td>
                    <td><?php echo $row[2] ;?></td>
                    <td><?php echo $row_info[1] ;?></td>
