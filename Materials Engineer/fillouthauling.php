                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row col-lg-12">
                                            ...
                                            <select class="form-control col-lg-9 " name="projectName" id="projects" required>
                                                <option value="Choose a project" selected disabled>Choose a project</option>
                                                <?php
                                                $sql = "SELECT 
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#articles').on('change', function() {
            ...
            $.get('http://localhost/Materials%20Engineer/../server.php?mat_name=' + $(this)
                .children(
                    'option:selected').val(),
                function(data) {
